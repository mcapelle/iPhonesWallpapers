...
let iosVersions = [
    ...
    10.00, 10.01, 10.02, 10.03, 10.1, 10.11, 10.20, 10.21, 10.30, 10.31
]
...
let iDevices = [
    ...
    iDevice(name: "iPhone 5", resolution: (1136, 640), firstIOSVersion: 7.00, lastIOSVersion: 10.31),
    iDevice(name: "iPhone 5S", resolution: (1136, 640), firstIOSVersion: 7.00, lastIOSVersion: 10.31),
    iDevice(name: "iPhone 6", resolution: (1334, 750), firstIOSVersion: 8.00, lastIOSVersion: 10.31),
    iDevice(name: "iPhone 6 Plus", resolution: (1920, 1080), firstIOSVersion: 8.00, lastIOSVersion: 10.31),
    iDevice(name: "iPhone 6S", resolution: (1334, 750), firstIOSVersion: 9.00, lastIOSVersion: 10.31),
    iDevice(name: "iPhone 6S Plus", resolution: (1920, 1080), firstIOSVersion: 9.00, lastIOSVersion: 10.31),
    iDevice(name: "iPhone 7", resolution: (1334, 750), firstIOSVersion: 10.00, lastIOSVersion: 10.31),
    iDevice(name: "iPhone 7 Plus", resolution: (1920, 1080), firstIOSVersion: 10.00, lastIOSVersion: 10.31),
    iDevice(name: "iPad Mini 4", resolution: (2048, 1536), firstIOSVersion: 9.00, lastIOSVersion: 10.31),
    iDevice(name: "iPad Pro 9.7", resolution: (2048, 1536), firstIOSVersion: 9.3, lastIOSVersion: 10.31)
]
